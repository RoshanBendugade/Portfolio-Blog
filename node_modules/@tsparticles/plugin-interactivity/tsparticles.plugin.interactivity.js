...
(function (global, factory) {
    ...
    class Interactivity {
        detectsOn = exports.InteractivityDetect.window;
        events = new Events();
        modes;
        constructor(pluginManager, container) {
    ...
    function isDivModeEnabled(mode, divs) {
        return !!findItemFromSingleOrMultiple(divs, t => t.enable && engine.isInArray(mode, t.mode));
    }
