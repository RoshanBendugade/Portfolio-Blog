import { getItemsFromInitializer } from "@tsparticles/engine/lazy";
export async function loadInteractivityPlugin(engine) {
    engine.checkVersion("4.3.0");
    await engine.pluginManager.register(async (e) => {
        const interactivityEngine = e, interactivityPluginManager = interactivityEngine.pluginManager, { InteractivityPlugin } = await import("./InteractivityPlugin.js");
