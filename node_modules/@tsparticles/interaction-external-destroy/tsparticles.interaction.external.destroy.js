...
(function (global, factory) {
    ...
    function divDestroy(container, divs, destroyMode) {
        pluginInteractivity.divModeExecute(destroyMode, divs, (selector, div) => {
    ...
    function mouseDestroy(container, interactivityData) {
        ...
        processDestroy(container, new engine.Circle(mousePos.x, mousePos.y, radius + tolerance));
    }
    ...
    class Destroyer extends pluginInteractivity.ExternalInteractorBase {
        #maxDistance;
        ...
        interact(interactivityData) {
            ...
            if (mouseMoveStatus && hoverEnabled && engine.isInArray(destroyMode, hoverMode)) {
        ...
        isEnabled(interactivityData, particle) {
            ...
            return ((!!mouse.position && events.onHover.enable && engine.isInArray(destroyMode, events.onHover.mode)) ||
                pluginInteractivity.isDivModeEnabled(destroyMode, divs));
        }
    ...
    exports.loadExternalDestroyInteraction = loadExternalDestroyInteraction;

}));
Object.assign(globalThis.window || globalThis, { loadExternalDestroyInteraction: (globalThis.__tsParticlesInternals.interactions.externalDestroy || {}).loadExternalDestroyInteraction });
