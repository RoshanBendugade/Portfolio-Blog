...
(function (global, factory) {
    ...
    class Parallax {
        ...
        load(data) {
            ...
            engine.loadProperty(this, "force", data.force);
            engine.loadProperty(this, "smooth", data.smooth);
        }
    }

    const parallaxMode = "parallax";
    class Parallaxer extends pluginInteractivity.ExternalInteractorBase {
        maxDistance = 0;
        ...
        isEnabled(interactivityData, particle) {
            ...
            return !!events?.onHover.enable && !!mouse.position && engine.isInArray(parallaxMode, events.onHover.mode);
        }
        loadModeOptions(options, ...sources) {
            engine.loadOptionProperty(options, "parallax", Parallax, ...sources);
        }
        reset() {
        }
        #parallaxInteract(interactivityData, particle) {
            ...
            const canvasSize = container.canvas.size, canvasCenter = {
                x: canvasSize.width * engine.half,
                y: canvasSize.height * engine.half,
...
Object.assign(globalThis.window || globalThis, { loadExternalParallaxInteraction: (globalThis.__tsParticlesInternals.interactions.externalParallax || {}).loadExternalParallaxInteraction });
