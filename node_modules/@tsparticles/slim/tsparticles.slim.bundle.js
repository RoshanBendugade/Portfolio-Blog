...
(function (global, factory) {
    ...
    function isPointInside(point, size, offset, radius, direction) {
        return areBoundsInside(calculateBounds(point, radius ?? minRadius$3), size, offset, direction);
    }
    ...
    function getHdrStyleFromRgb(color, opacity, peakNits = maxNits) {
        ...
        return `color(display-p3 ${((color.r / rgbMax) * headroom).toString()} ${((color.g / rgbMax) * headroom).toString()} ${((color.b / rgbMax) * headroom).toString()} / ${(opacity ?? defaultOpacity$3).toString()})`;
    }
    ...
    const minFactor = 1, minRadius$2 = 0, updateVector = Vector.origin;
    ...
    function clickAttract(pluginManager, container, interactivityData, enabledCb, onAttractParticle) {
        ...
        if (attract.clicking) {
            ...
            if (!attractRadius || attractRadius < minRadius$2 || !mousePos) {
                return;
            }
    ...
    function mouseBounce(container, interactivityData, enabledCb) {
        ...
        if (!radius || radius < minRadius$4 || !mousePos) {
            return;
        }
