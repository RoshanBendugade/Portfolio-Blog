...
(function (global, factory) {
    ...
    class Remover extends pluginInteractivity.ExternalInteractorBase {
        handleClickMode;
        maxDistance = 0;
        constructor(container) {
            ...
            this.handleClickMode = (mode) => {
                ...
                const removeNb = engine.getRangeValue(options.interactivity.modes.remove.quantity);
        ...
        isEnabled(interactivityData, particle) {
            ...
            return !!events && mouse.clicking && mouse.inside && !!mouse.position && engine.isInArray(removeMode, events.onClick.mode);
        }
        loadModeOptions(options, ...sources) {
            engine.loadOptionProperty(options, "remove", Remove, ...sources);
        }
        reset() {
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadExternalRemoveInteraction: (globalThis.__tsParticlesInternals.interactions.externalRemove || {}).loadExternalRemoveInteraction });
