...
(function (global, factory) {
    ...
    class StarDrawer {
        ...
        getSidesCount(particle) {
            ...
            return Math.round(engine.getRangeValue(star?.sides ?? defaultSides));
        }
        particleInit(_container, particle) {
            const star = particle.shapeData;
            particle.starInset = engine.getRangeValue(star?.inset ?? defaultInset);
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadStarShape: (globalThis.__tsParticlesInternals.shapes.star || {}).loadStarShape });
