...
(function (global, factory) {
    ...
    class Push {
        ...
        load(data) {
            ...
            engine.loadProperty(this, "default", data.default);
    ...
    class Pusher extends pluginInteractivity.ExternalInteractorBase {
        handleClickMode;
        maxDistance = 0;
        constructor(container) {
            ...
            this.handleClickMode = (mode, interactivityData) => {
                ...
                const quantity = engine.getRangeValue(pushOptions.quantity);
                if (quantity <= minQuantity) {
                    return;
                }
                const group = engine.itemFromArray([undefined, ...pushOptions.groups]), groupOptions = group !== undefined ? container.actualOptions.particles.groups[group] : undefined, particlesOptions = engine.itemFromSingleOrMultiple(pushOptions.particles), overrideOptions = engine.deepExtend(groupOptions, particlesOptions);
        ...
        isEnabled(interactivityData, particle) {
            ...
            return !!events && mouse.clicking && mouse.inside && !!mouse.position && engine.isInArray(pushMode, events.onClick.mode);
        }
        loadModeOptions(options, ...sources) {
            engine.loadOptionProperty(options, "push", Push, ...sources);
        }
        reset() {
        }
    }
...
Object.assign(globalThis.window || globalThis, { loadExternalPushInteraction: (globalThis.__tsParticlesInternals.interactions.externalPush || {}).loadExternalPushInteraction });
